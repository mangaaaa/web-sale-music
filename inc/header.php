  ...
  <div class="container" >
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      ...
	      <li class="nav-item dropdown">
	        <a class="nav-link" href="#" id="navbarDropdown" ><i class="fas fa-user"></i>
	          Account
	        </a>
	        <div class="dropdown-content">
	          <a class="dropdown-item" href="signup.php">Sign Up</a>
	           <a class="dropdown-item" href="user/login.php">Log in</a>
	        </div>
	     <li class="nav-item">
	        <a class="nav-link" href="user/login.php"><i class="fas fa-cart-plus"></i> Cart</a>
	      </li>
	    </ul>
