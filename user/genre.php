...
<div class="container-fluid">
  <div class="row">
    <div style="border-bottom:4px solid #C63D5D;width: 100%">
          ...
          <?php 
    $sql="SELECT song.SongID,song.SongName,song.SongPrice,song.SongIMG,singer.SingerName,genre.GenreName FROM song,singer,genre WHERE singer.SingerID=song.SingerID and genre.GenreID=song.GenreID And song.GenreID LIKE '%{$id1}%'";
